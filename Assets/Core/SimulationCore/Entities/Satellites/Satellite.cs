...
namespace Entities
{
    ...
    public class Satellite : MonoBehaviour, ISatellite, ISelectable
    {
        ...
        public SatelliteInfoSO Info => _info;
        ...
        public void Select()
        {
            if (IsSelected == false)
            {
                ...
                DOFController.Instance.EnableDOF();
                ShowMesh();
                OnSelect?.Invoke();
            }
        }
        public void DeSelect()
        {
            if (IsSelected)
            {
                ...
                DOFController.Instance.DisableDOF();
                HideMesh();
                OnDeselect?.Invoke();
            }
        }
